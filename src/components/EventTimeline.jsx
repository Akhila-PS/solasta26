...
const schedule = {
  "Pre-Events": [
    ...
    },
    {
      id: "lan-gaming",
      title: "LAN Gaming",
      time: "4 PM – 6 PM, Mar 3",
      venue: "Seminar Hall",
      type: "gaming",
      description: "Experience high-speed, low-latency gaming with friends on LAN.",
    },
    {
      id: "murder-mystery",
      title: "Murder Mystery",
      time: "4 PM – 6 PM, Mar 4",
      venue: "TBD",
      type: "fun",
  ...
  "Day 2 — Mar 7": [
    ...
    },
    {
      ...
      venue: "Classroom",
      type: "technical",
      description: "Explore innovative projects, tools, and VR experiences by students.",
    },
  ],
  "Day 3 — Mar 8": [
    {
